...
public class StatePlanning {
    public static List<Integer> statePlanning(int numCities, int numRoads, int numTypes,
                                              List<Integer> fromCity, List<Integer> toCity, List<Integer> roadType) {
    ...
    public static void main(String[] args) {
        ...
        List<Integer> fromCity = Arrays.asList(3, 0, 0, 2, 11);
        List<Integer> toCity = Arrays.asList(2, 3, 2, 1, 31);
        List<Integer> roadType = Arrays.asList(1, 0, 0, 1, 11);
